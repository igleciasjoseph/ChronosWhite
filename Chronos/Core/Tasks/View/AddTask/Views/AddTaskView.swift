    ...
    var body: some View {
        ...
        GeometryReader { proxy in
            VStack {
                ...
                AddTaskButtonView(title: $title, taskDescription: $taskDescription, startDate: $startDate, startTime: $startTime, endTime: $endTime, tintColor: $tintColor, priority: $priority, isComplete: $isComplete, tabSelection: $tabSelection)
