...
struct EditTaskView: View {
    ...
    var body: some View {
        ...
        .overlay(alignment: .bottom) {
            EditOverlayView(task: .constant(task), title: $title, taskDescription: $taskDescription, startDate: $startDate, startTime: $startTime, endTime: $endTime, tintColor: $tintColor, priority: $priority)
        }
